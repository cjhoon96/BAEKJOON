		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzfiorib23master-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzfiorib23master-display": {
								"semanticObject": "iitpzfiorib23master",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zfiorib23master",
									"url": sap.ui.require.toUrl("iitp/zfiorib23master")
								}
							}
						}
					}
