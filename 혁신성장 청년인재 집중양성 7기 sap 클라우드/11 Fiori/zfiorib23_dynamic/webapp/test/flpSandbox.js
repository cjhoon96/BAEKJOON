		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzfiorib23dynamic-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzfiorib23dynamic-display": {
								"semanticObject": "iitpzfiorib23dynamic",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zfiorib23dynamic",
									"url": sap.ui.require.toUrl("iitp/zfiorib23dynamic")
								}
							}
						}
					}
