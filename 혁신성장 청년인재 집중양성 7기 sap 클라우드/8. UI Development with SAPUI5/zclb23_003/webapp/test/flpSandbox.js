		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#IITPzclb23003-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IITPzclb23003-display": {
								"semanticObject": "IITPzclb23003",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=IITP.zclb23003",
									"url": sap.ui.require.toUrl("IITP/zclb23003")
								}
							}
						}
					}
