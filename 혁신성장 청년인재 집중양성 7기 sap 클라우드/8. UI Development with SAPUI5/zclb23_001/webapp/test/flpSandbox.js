		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#IITPzclb23001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IITPzclb23001-display": {
								"semanticObject": "IITPzclb23001",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=IITP.zclb23001",
									"url": sap.ui.require.toUrl("IITP/zclb23001")
								}
							}
						}
					}
