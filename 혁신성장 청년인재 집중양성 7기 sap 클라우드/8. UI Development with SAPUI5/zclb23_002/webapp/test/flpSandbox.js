		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#IITPzclb23002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IITPzclb23002-display": {
								"semanticObject": "IITPzclb23002",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=IITP.zclb23002",
									"url": sap.ui.require.toUrl("IITP/zclb23002")
								}
							}
						}
					}
