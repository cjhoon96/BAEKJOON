		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitp23cjhzdayb2303-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitp23cjhzdayb2303-display": {
								"semanticObject": "iitp23cjhzdayb2303",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp23.cjh.zdayb2303",
									"url": sap.ui.require.toUrl("iitp23/cjh/zdayb2303")
								}
							}
						}
					}
