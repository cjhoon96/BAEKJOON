		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzdayb2302-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzdayb2302-display": {
								"semanticObject": "iitpzdayb2302",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zdayb2302",
									"url": sap.ui.require.toUrl("iitp/zdayb2302")
								}
							}
						}
					}
