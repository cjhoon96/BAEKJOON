		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpcjhzdayb2304combo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpcjhzdayb2304combo-display": {
								"semanticObject": "iitpcjhzdayb2304combo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.cjh.zdayb2304combo",
									"url": sap.ui.require.toUrl("iitp/cjh/zdayb2304combo")
								}
							}
						}
					}
