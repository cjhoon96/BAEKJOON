		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzdayb2305-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzdayb2305-display": {
								"semanticObject": "iitpzdayb2305",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zdayb2305",
									"url": sap.ui.require.toUrl("iitp/zdayb2305")
								}
							}
						}
					}
