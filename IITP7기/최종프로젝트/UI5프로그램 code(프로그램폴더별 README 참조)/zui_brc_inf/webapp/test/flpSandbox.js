		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#krgoiitpgr5clb05zuibrcinf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"krgoiitpgr5clb05zuibrcinf-display": {
								"semanticObject": "krgoiitpgr5clb05zuibrcinf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kr.go.iitp.gr5.clb05.zuibrcinf",
									"url": sap.ui.require.toUrl("kr/go/iitp/gr5/clb05/zuibrcinf")
								}
							}
						}
					}
