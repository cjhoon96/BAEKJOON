		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Branch Stock",
									"targetURL": "#krgoiitpgr5clb05zuibrcstk-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"krgoiitpgr5clb05zuibrcstk-display": {
								"semanticObject": "krgoiitpgr5clb05zuibrcstk",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kr.go.iitp.gr5.clb05.zuibrcstk",
									"url": sap.ui.require.toUrl("kr/go/iitp/gr5/clb05/zuibrcstk")
								}
							}
						}
					}
