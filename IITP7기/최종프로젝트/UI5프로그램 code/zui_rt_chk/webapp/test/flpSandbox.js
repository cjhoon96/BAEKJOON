		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Requested R/T by Headquarter",
									"targetURL": "#krgoiitpgr5clb05zuirtchk-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"krgoiitpgr5clb05zuirtchk-display": {
								"semanticObject": "krgoiitpgr5clb05zuirtchk",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kr.go.iitp.gr5.clb05.zuirtchk",
									"url": sap.ui.require.toUrl("kr/go/iitp/gr5/clb05/zuirtchk")
								}
							}
						}
					}
