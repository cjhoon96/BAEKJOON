		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#krgoiitpgr5clb05zuirtsnd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"krgoiitpgr5clb05zuirtsnd-display": {
								"semanticObject": "krgoiitpgr5clb05zuirtsnd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kr.go.iitp.gr5.clb05.zuirtsnd",
									"url": sap.ui.require.toUrl("kr/go/iitp/gr5/clb05/zuirtsnd")
								}
							}
						}
					}
