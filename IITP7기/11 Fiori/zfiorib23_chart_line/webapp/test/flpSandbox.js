		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzfiorib23chartline-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzfiorib23chartline-display": {
								"semanticObject": "iitpzfiorib23chartline",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zfiorib23chartline",
									"url": sap.ui.require.toUrl("iitp/zfiorib23chartline")
								}
							}
						}
					}
